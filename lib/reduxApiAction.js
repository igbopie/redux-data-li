...
var reduxApiActionInner = function (dispatch, _a) {
    var reducer = _a.reducer, apiFn = _a.apiFn, start = _a.start, fail = _a.fail, end = _a.end, shouldFetchFn = _a.shouldFetchFn, paramName = _a.paramName, params = _a.params;
...
var reduxApiAction = function (dispatch, params) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, reduxApiActionInner(dispatch, params)];
    });
}); };
