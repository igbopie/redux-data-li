...
exports.reducers = function (_a) {
    ...
    return ({
         ...
         */
        start: function (state, payload, globalState) {
            return start(state, { payload: payload, isLoading: true, error: null, data: null, lastUpdated: Date.now() }, globalState);
        },
        /**
        ...
        fail: function (state, _a, globalState) {
            ...
            return fail(state, { isLoading: false, error: error, data: null, lastUpdated: Date.now() }, globalState);
        },
        /**
         ...
         */
            ...
            return end(state, { isLoading: false, error: null, lastUpdated: Date.now(), data: response }, globalState);
        },
    });
};
/**
...
exports.reduxFnMap = function (actionsMap, initialState) {
    ...
    return function (state, _a, globalState) {
        ...
        if (actionsMap[type]) {
            return actionsMap[type].call({}, state, { payload: payload }, globalState);
        }
        return state;
    };
};
